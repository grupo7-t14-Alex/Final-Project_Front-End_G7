...
export const ModalAnnouncement = ({ sellerId }: any) => {
  ...
  const selectModel = async (event: any) => {
    const carFilter = Querybrand.filter(
    ...
    <ModalWrapper>
      ...
      >
        <div className="flex justify-between items-center">
          <h3 className="text-gray-100 font-bold text-base">Criar anuncio</h3>
          <Image
            src={closeModal}
            alt="close modal"
            width={30}
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="w-full flex gap-3.5">
            <div className="max-w-[50%]">
              ...
              {!isNumberYear && (
                <p className="text-[14px] text-red-500">Insira um ano válido</p>
              )}
            </div>
            <div className="max-w-[50%]">
              <Input
          ...
          <div className="w-full flex gap-3.5">
            <div className="max-w-[50%]">
              <Input
                ...
                value={
                  carInfo &&
                  carInfo[0].value.toLocaleString("pt-BR", {
                    style: "currency",
                    currency: "BRL",
                  })
                }
