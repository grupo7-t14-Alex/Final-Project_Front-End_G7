...
const colorClasses = {
  ...
  grey6:
    "bg-[#DEE2E6] border-[#DEE2E6] text-[#495057] hover:bg-[#CED4DA] hover:border-[#CED4DA]",
  grey10: "bg-[#FDFDFD] border-[#FDFDFD] text-[#212529]",
  disabled: "bg-[#CED4DA] border-[#CED4DA] text-[#FFFFFF]",
  brand1:
    "bg-[#4529E6] border-[#4529E6] text-[#FFFFFF] hover:bg-[#5126EA] hover:border-[#5126EA]",
  ...
  alert:
    "bg-[#FFE5E5] border-[#FFE5E5] text-[#CD2B31] hover:bg-[#FDD8D8] hover:border-[#FDD8D8]",
  success:
...
export const Button = ({ size, type, color, borderstyle, children, border, className}: ButtonProps) => {
