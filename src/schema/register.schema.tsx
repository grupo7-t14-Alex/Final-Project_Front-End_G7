...
export const registerSchema = z
  .object({
    ...
    cpf: z
      .string()
      .min(11, "digite seu CPF(digite 11 numeros)")
      .max(11, "digite seu CPF (apenas 11 numeros)"),
    phone: z
      .string()
    ...
    cep: z
      .string()
      .min(5, "Digite o seu CEP (apenas numeros)")
      .max(11, "Digite o seu CEP (apenas numeros)"),
    state: z
      .string()
      .min(2, "estado invalido, EX: SP")
      .max(2, "digite apenas 2 caracteres, EX: SP"),
    city: z
      .string()
      .min(3, "minimo 3 caracteres")
      .max(40, "maximo 40 caracteres"),
...
export const schema = z.object({
  name: z.string().min(3, 'minimo 3 caracteres').max(40, 'maximo 40 caracteres').optional(),
  email: z.string().email('digite um email valido').optional(),
  cpf: z.string().min(11, 'digite seu CPF(digite 11 numeros)').max(11, 'digite seu CPF (apenas 11 numeros)').optional(),
  phone: z.string().min(11, 'digite seu Celular com DDD').max(11, 'digite seu Celular com DDD').optional(),
  birthDate: z.string().min(8, 'sua data de nacimento (apenas numeros)').max(8, 'sua data de nacimento (apenas numeros)').optional(),
  description: z.string().optional(),
  seller: z.boolean().default(false).optional(),
  password: z.string()
    .min(8, { message: 'Mínimo de 8 caracteres' })
    .max(20, { message: 'Máximo de 20 caracteres' })
