...
export default function Home() {
  const { filterModal, setFilterModal, cars } = useContext(carsContext);

  const { token, user, openModalUp, openModalUpAddress } =
      ...
      <main className="bg-white">
        <div className="z-1  w-full relative h-[627px] lg:h-[544px]  bg-gradient-to-t from-gray-0 from-30% via-gray-300 via-100%">
          <Image
            src={homeCar}
            alt="Home Car"
            className="w-full h-full   mix-blend-overlay lg:hidden"
          />
          <Image
            src={homeCarLg}
            alt="Home Car"
            className="w-full h-full   mix-blend-overlay hidden lg:block"
          />
          <div className="h-[345px] lg:h-full w-full flex flex-col justify-center items-center gap-5 absolute top-[138px] lg:top-0 ">
            <h2 className="font-lexend text-4xl font-bold text-center text-gray-1000">
              Motors Shop
            </h2>
            <p className="w-full font-lexend text-3xl font-semibold text-center text-gray-1000">
        ...
        <section className="flex gap-12 flex-col lg:flex-row">
          ...
          <div className="flex flex-col w-full lg:w-[70%]">
            ...
            <div className="hidden lg:flex flex-col justify-center">
              ...
              <div className="flex flex-row justify-center space-x-6">
                <button
                  type="button"
                  className="py-2 px-4 bg-transparent text-purple-800 hover:text-gray-900 rounded-md"
                >
                  {"<"} Voltar
                </button>
                <button
          ...
          <div className="w-full flex flex-col justify-center items-center lg:hidden">
            <button
              type="button"
              className=" w-64 py-2 px-4 text-white bg-purple-800 hover:bg-purple-900 rounded-md"
